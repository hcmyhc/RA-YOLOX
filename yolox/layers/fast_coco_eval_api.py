...
class COCOeval_opt(COCOeval):
    """
    This is a slightly modified version of the original coco128 API, where the functions evaluateImg()
    ...
    def evaluate(self):
        ...
        accumulate().  Unlike the original coco128 PythonAPI, we don't populate the datastructure
        ...
        # <<<< Beginning of code differences with original coco128 API
        ...
        # >>>> End of code differences with original coco128 API
